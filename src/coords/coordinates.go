...
func initializePlatforms() {
	...
	Platform[7] = dtypes.Rect{XHi: 0, YHi: 550, XLo: 1200, YLo: 600}
	...
	Gems[3] = dtypes.Gem{
		Gemtype: '*',
		Value:   2,
		Pos:     dtypes.Rect{XHi: 600, YHi: 510, XLo: 630, YLo: 550},
	}

	Freepositions[0] = dtypes.Freepos{Available: true, Pos: dtypes.Rect{XHi: 900, YHi: 80, XLo: 930, YLo: 120}}
	Freepositions[1] = dtypes.Freepos{Available: true, Pos: dtypes.Rect{XHi: 700, YHi: 510, XLo: 730, YLo: 550}}
	Freepositions[2] = dtypes.Freepos{Available: true, Pos: dtypes.Rect{XHi: 280, YHi: 285, XLo: 310, YLo: 325}}
	Freepositions[3] = dtypes.Freepos{Available: true, Pos: dtypes.Rect{XHi: 900, YHi: 400, XLo: 930, YLo: 440}}
	...
	Randompos[7] = dtypes.Position{X: 1015, Y: 420} // 1000, 400
...
func Initialize() {
	...
	for z := 0; z < 6; z++ {
		// write all distances.
		dijkstra.Allnodes[z][0] = dijkstra.StaticNode{Location: dtypes.Position{X: 15, Y: 25}, NodeID: 1, XNodeID: 15, YNodeID: 25}
		dijkstra.Allnodes[z][1] = dijkstra.StaticNode{Location: dtypes.Position{X: 385, Y: 25}, NodeID: 1, XNodeID: 385, YNodeID: 25}
		dijkstra.Allnodes[z][2] = dijkstra.StaticNode{Location: dtypes.Position{X: 855, Y: 25}, NodeID: 1, XNodeID: 855, YNodeID: 25}
		dijkstra.Allnodes[z][3] = dijkstra.StaticNode{Location: dtypes.Position{X: 785, Y: 105}, NodeID: 2, XNodeID: 785, YNodeID: 105}
		dijkstra.Allnodes[z][4] = dijkstra.StaticNode{Location: dtypes.Position{X: 855, Y: 105}, NodeID: 2, XNodeID: 855, YNodeID: 105}
		dijkstra.Allnodes[z][5] = dijkstra.StaticNode{Location: dtypes.Position{X: 1185, Y: 105}, NodeID: 2, XNodeID: 1185, YNodeID: 105}
		dijkstra.Allnodes[z][6] = dijkstra.StaticNode{Location: dtypes.Position{X: 15, Y: 180}, NodeID: 3, XNodeID: 15, YNodeID: 180}
		dijkstra.Allnodes[z][7] = dijkstra.StaticNode{Location: dtypes.Position{X: 385, Y: 180}, NodeID: 3, XNodeID: 385, YNodeID: 180}
		dijkstra.Allnodes[z][8] = dijkstra.StaticNode{Location: dtypes.Position{X: 415, Y: 180}, NodeID: 3, XNodeID: 415, YNodeID: 180}
		dijkstra.Allnodes[z][9] = dijkstra.StaticNode{Location: dtypes.Position{X: 585, Y: 190}, NodeID: 4, XNodeID: 585, YNodeID: 190}
		dijkstra.Allnodes[z][10] = dijkstra.StaticNode{Location: dtypes.Position{X: 785, Y: 190}, NodeID: 4, XNodeID: 785, YNodeID: 190}
		dijkstra.Allnodes[z][11] = dijkstra.StaticNode{Location: dtypes.Position{X: 815, Y: 190}, NodeID: 4, XNodeID: 815, YNodeID: 190}
		dijkstra.Allnodes[z][12] = dijkstra.StaticNode{Location: dtypes.Position{X: 1185, Y: 190}, NodeID: 4, XNodeID: 1185, YNodeID: 190}
		dijkstra.Allnodes[z][13] = dijkstra.StaticNode{Location: dtypes.Position{X: 15, Y: 305}, NodeID: 5, XNodeID: 15, YNodeID: 305}
		dijkstra.Allnodes[z][14] = dijkstra.StaticNode{Location: dtypes.Position{X: 415, Y: 305}, NodeID: 5, XNodeID: 415, YNodeID: 305}
		dijkstra.Allnodes[z][15] = dijkstra.StaticNode{Location: dtypes.Position{X: 585, Y: 305}, NodeID: 5, XNodeID: 585, YNodeID: 305}
		dijkstra.Allnodes[z][16] = dijkstra.StaticNode{Location: dtypes.Position{X: 815, Y: 305}, NodeID: 5, XNodeID: 815, YNodeID: 305}
		dijkstra.Allnodes[z][17] = dijkstra.StaticNode{Location: dtypes.Position{X: 155, Y: 430}, NodeID: 6, XNodeID: 155, YNodeID: 430}
		dijkstra.Allnodes[z][18] = dijkstra.StaticNode{Location: dtypes.Position{X: 185, Y: 430}, NodeID: 6, XNodeID: 185, YNodeID: 430}
		dijkstra.Allnodes[z][19] = dijkstra.StaticNode{Location: dtypes.Position{X: 415, Y: 430}, NodeID: 6, XNodeID: 415, YNodeID: 430}
		dijkstra.Allnodes[z][20] = dijkstra.StaticNode{Location: dtypes.Position{X: 545, Y: 430}, NodeID: 6, XNodeID: 545, YNodeID: 430}
		dijkstra.Allnodes[z][21] = dijkstra.StaticNode{Location: dtypes.Position{X: 785, Y: 420}, NodeID: 7, XNodeID: 785, YNodeID: 420}
		dijkstra.Allnodes[z][22] = dijkstra.StaticNode{Location: dtypes.Position{X: 815, Y: 420}, NodeID: 7, XNodeID: 815, YNodeID: 420}
		dijkstra.Allnodes[z][23] = dijkstra.StaticNode{Location: dtypes.Position{X: 1185, Y: 420}, NodeID: 7, XNodeID: 1185, YNodeID: 420}
		dijkstra.Allnodes[z][24] = dijkstra.StaticNode{Location: dtypes.Position{X: 15, Y: 530}, NodeID: 8, XNodeID: 15, YNodeID: 530}
		dijkstra.Allnodes[z][25] = dijkstra.StaticNode{Location: dtypes.Position{X: 155, Y: 530}, NodeID: 8, XNodeID: 155, YNodeID: 530}
		dijkstra.Allnodes[z][26] = dijkstra.StaticNode{Location: dtypes.Position{X: 185, Y: 530}, NodeID: 8, XNodeID: 185, YNodeID: 530}
		dijkstra.Allnodes[z][27] = dijkstra.StaticNode{Location: dtypes.Position{X: 545, Y: 530}, NodeID: 8, XNodeID: 545, YNodeID: 530}
		dijkstra.Allnodes[z][28] = dijkstra.StaticNode{Location: dtypes.Position{X: 785, Y: 530}, NodeID: 8, XNodeID: 785, YNodeID: 530}
		dijkstra.Allnodes[z][29] = dijkstra.StaticNode{Location: dtypes.Position{X: 1185, Y: 530}, NodeID: 8, XNodeID: 1185, YNodeID: 530}
		dijkstra.Allnodes[z][30] = dijkstra.StaticNode{Location: dtypes.Position{X: 115, Y: 180}, NodeID: 3, XNodeID: 115, YNodeID: 180}
		dijkstra.Allnodes[z][31] = dijkstra.StaticNode{Location: dtypes.Position{X: 115, Y: 305}, NodeID: 32, XNodeID: 115, YNodeID: 305}
